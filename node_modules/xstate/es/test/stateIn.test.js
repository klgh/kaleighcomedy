...
describe('transition "in" check', function () {
    ...
    it('matching should be relative to grandparent (match)', function () {
        assert.deepEqual(machine.transition({ a: 'a1', b: { b2: { foo: 'foo1', bar: 'bar1' } } }, 'EVENT_DEEP').value, {
            a: 'a1',
            b: {
                b2: {
                    foo: 'foo2',
    ...
    it('matching should be relative to grandparent (no match)', function () {
        assert.deepEqual(machine.transition({ a: 'a1', b: { b2: { foo: 'foo1', bar: 'bar2' } } }, 'EVENT_DEEP').value, {
            a: 'a1',
            b: {
                b2: {
                    foo: 'foo1',
    ...
    it('should work to forbid events', function () {
        ...
        assert.deepEqual(stopState.value, 'green', 'Transition allowed due to "in" clause');
    });
});
//# sourceMappingURL=stateIn.test.js.map