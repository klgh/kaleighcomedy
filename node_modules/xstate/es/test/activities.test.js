...
describe('activities with guarded transitions', function () {
    ...
    it('should activate even if there are subsequent automatic, but blocked transitions', function () {
        ...
        assert.deepEqual(state.actions, [start({ type: 'B_ACTIVITY', id: 'B_ACTIVITY', exec: undefined })]);
        // assert.isFunction(
...
describe('activities', function () {
    ...
    it('identifies start activities', function () {
        ...
        assert.sameDeepMembers(nextState.actions, [start('activateCrosswalkLight')]);
    });
    ...
    it('identifies multiple stop activities for child and parent states', function () {
        ...
        assert.isFalse(nextState.activities.blinkCrosswalkLight);
        assert.sameDeepMembers(nextState.actions, [start('fadeInGreen'), stop('activateCrosswalkLight')]);
    });
});
